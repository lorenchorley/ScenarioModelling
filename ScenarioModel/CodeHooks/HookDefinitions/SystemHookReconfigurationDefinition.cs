...
public class SystemHookReconfigurationDefinition
{
    private readonly SystemHookDefinition _systemHookDefinition;

    public SystemHookReconfigurationDefinition(SystemHookDefinition systemHookDefinition)
    {
        _systemHookDefinition = systemHookDefinition;
    }

    public EntityHookDefinition RedefineEntity(string name)
    {
        EntityHookDefinition nodeDef =
            _systemHookDefinition.EntityDefintions
