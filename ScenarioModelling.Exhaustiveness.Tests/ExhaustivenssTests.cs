...
namespace ScenarioModelling.Exhaustiveness.Tests;
...
public class ExhaustivenssTests
{
    ...
    public void FullyImplemented()
    {
        ...
        // Act && Assert
        // =============
        functions.AssertThatInterfaceIsExhaustivelyImplemented<IFullyImplementedTestNodeBase>();
    ...
    public void NotFullyImplemented()
    {
        ...
        // Act
        // ===
        Action action = () => functions.AssertThatInterfaceIsExhaustivelyImplemented<INotFullyImplementedTestNodeBase>();
    ...
    public void DoublyImplemented_ExtraImplementation()
    {
        ...
        // Act
        // ===
        Action action = () => functions.AssertThatInterfaceIsExhaustivelyImplemented<IDoublyImplementedTestNodeBase>();
    ...
    public void OverlyImplemented_UntaggedImplementation()
    {
        ...
        Action action = () => functions.AssertThatInterfaceIsExhaustivelyImplemented<IOverlyImplementedTestNodeBase>();
