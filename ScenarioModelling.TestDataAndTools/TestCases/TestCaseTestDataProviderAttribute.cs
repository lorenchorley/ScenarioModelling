...
public class TestCaseTestDataProviderAttribute : Attribute, ITestDataSource
{
    ...
    private List<TestCaseTestCase> TestData = [
            ...
            new(nameof(TestCaseTestData.OneStateChange_InitialStateDifferent_OneAssertion_Fails_OnAssertion)),
            new(nameof(TestCaseTestData.OneState_MultipleInitialStates_OneAssertion_Fails_OnUndefinedEntity)),
