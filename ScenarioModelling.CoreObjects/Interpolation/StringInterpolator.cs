...
namespace ScenarioModelling.CoreObjects.Interpolation;
public class StringInterpolator(MetaState metaState)
{
    ...
    private string Interpolate(string expression)
    {
        ...
        {
            var entity = metaState.AllStateful.FirstOrDefault(e => e.Name == entityName);
